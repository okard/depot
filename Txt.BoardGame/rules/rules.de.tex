...
\subsection{Der Spielstein}
	...
	\centering
	\includegraphics[scale=2]{generated/simple/token.pdf}
	...
	\begin{wrapfigure}{r}{6.2cm}
  	\includegraphics[scale=1]{generated/simple/token_on_board.pdf}
	...
	%Durch eine Beförderung des Spielsteins, also das umdrehen
...
\subsection{Spielzüge}
	...
	%	  \textcolor{red}{Befördern gestrichen um mehr einen Austausch Stil spielen zu können}
	...
	\begin{figure}[h]
	\includegraphics[scale=0.8]{generated/simple/board_situation1.pdf}
	\end{figure}
...
\subsection{Der Spielzug}
	...
	\begin{wrapfigure}{l}{6.2cm}
  	\includegraphics[scale=0.5]{generated/simple/move_decision_tree.pdf}
